...
//       if (photoFile) {
//         formData.append("photo", photoFile); // ✅ FIXED KEY
//       }
...
//           {photo ? (
//             <img
//               src={photo}   // ✅ Cloudinary URL or preview
//               className="profile-img"
//               alt="profile"
//             />
//           ) : (
...
function Profile() {
  ...
  const loadProfile = async () => {
    try {
      ...
      // 🔥 IMPORTANT → update navbar/dashboard instantly
      localStorage.setItem("user", JSON.stringify(data));
      window.dispatchEvent(new Event("userUpdated"));
  ...
  const handleSave = async () => {
    try {
      ...
      if (photoFile) {
        formData.append("photo", photoFile); // ✅ MUST match backend
      }
    ...
    <div className="profile-container">
      <div className="profile-card">
        ...
        <div className="avatar-wrapper">
          {photo ? (
            <img
              src={photo}   // ✅ Cloudinary OR preview both work
              className="profile-img"
              alt="profile"
            />
          ) : (
